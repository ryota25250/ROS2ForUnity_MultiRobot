...
public class LiDAR : MonoBehaviour
{
    ...
    public double PublishPeriodSeconds = 0.2;
    public float RangeMetersMin = 0.1f;
    public float RangeMetersMax = 10;
    ...
    public void Update()
    {
        ...
        while (m_NumMeasurementsTaken < measurementsSoFar)
        {
            ...
            {
                // [MODIFIED] Use PositiveInfinity for out-of-range measurements, which is standard for ROS.
